  ...
  return (
    <div className="App">
      {superheroes.map((superhero) => (
        <Superhero name={superhero.name} universe={superhero.universe} alterego={superhero.alterego} occupation={superhero.occupation} friends={superhero.friends} superpowers={superhero.superpowers} url={superhero.url} ></Superhero>
      ))}
    </div>
  );
}
